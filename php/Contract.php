    ...
    <table>
        <tr>
            <td>
                ...
                Facebook: XXXXXXXX
                <br>
                Instragram: xxxxxxxxx
            </td>
            <td>
                <h3>ตัวเลือก</h3>
                <a href="../../../index.php" style="text-decoration: none; color:black;">หน้าเเรก</a>
                <br>
                <a href="../../../php/booking/booking.php" style="text-decoration: none; color:black;">รายละเอียดห้อง</a>
                <br>
    ...
    <table>
        <tr>
            ...
            <td>
                ...
                <br>
                <a href="../../../php/booking/booking.php" style="text-decoration: none; color:black;">Room Detail</a>
                <br>
